import o from "react";
const t = "use-render-flash", a = "__use-render-flash-style__", l = () => {
  ...
  return o.useEffect(() => {
    ...
    if (e) {
      ...
      return e.style.setProperty("--flash-color", r), e.style.setProperty("--flash-duration", s), e.offsetWidth, e.classList.add(t), () => {
        e.classList.remove(t), e.style.removeProperty("--flash-color"), e.style.removeProperty("--flash-duration");
      };
    }
  }), n;
};
